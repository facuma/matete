...
import { Upload, X, Image as ImageIcon, Check, Loader2, Trash2, Link as LinkIcon } from 'lucide-react';
import Button from '@/components/ui/Button';
import { toast } from 'sonner';
import { cn } from '@/lib/utils';

export default function ImageGallery({ onSelect, currentImage }) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="md:col-span-1 bg-white rounded-xl border border-stone-200 p-6 flex flex-col justify-center shadow-sm">
                    ...
                    <div className="space-y-3">
                        ...
                        <Button type="button" onClick={handleUrlSubmit} variant="secondary" className="w-full justify-center" disabled={!urlInput || uploading}>
                            {uploading ? 'Importando...' : 'Importar URL'}
                        </Button>
                    </div>
                </div>
            </div>
